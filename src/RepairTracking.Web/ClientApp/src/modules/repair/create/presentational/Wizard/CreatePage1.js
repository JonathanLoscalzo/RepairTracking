...
const CreatePage1 = (props) => {
  const { handleSubmit, client } = props;
  return (
      <div>
          <form onSubmit={handleSubmit}>
            <fieldset>
                <legend>Información</legend>
                <Field label="Elemento (*)" name="element" placeholder="Código" component={RenderField} type="text" />
                <Field label="Monto (*)" name="amount" placeholder="Monto" component={RenderField} type="text" />
                <Field label="Cliente (*)" name="client" placeholder="Cliente" client={client} component={RenderFieldDisabled} type="text" />
